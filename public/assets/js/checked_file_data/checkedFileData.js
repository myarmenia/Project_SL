            ...
            function sendCheckedId(dataID) {
                fetch(`/likeFileDetailItem`, {
                    ...
                    .then((data) => {
                        ...
                        //delate process
                        const general_element = document.getElementById(
                            dataID.fileItemId
                        );
                        console.log("general_element",general_element);
                        child.forEach((el) => {
                        ...
                        // Insert the new row after general_element
                        general_element.insertAdjacentElement(
                            "afterend",
                            newRow
                        );
                        general_element.remove();
                    })
                    .catch((error) => {
...
////check button click
var checkButtons = document.querySelectorAll(".check_btn");
