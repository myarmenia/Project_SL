...
function onBlur() {
    ...
    if (this.value && this.value !== ' ') {
        ...
        console.log(!hasValue && this.value !== '' && !document.querySelector('.error-modal').classList.contains('activeErrorModal') && this.hasAttribute('list') || !hasValue && this.value !== '' && !this.hasAttribute('list'))
