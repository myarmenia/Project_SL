...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'start-action-date' => [
            'required'=>'Գործողության սկիզբ  ամսաթիվ բացակայում է։'
        ],

        'end-action-date' => [
            'required'=>'Գործողության ավարտ  ամսաթիվ բացակայում է։'
        ],

        'value' => [
            'integer'=>'Դաշտը պետք է լինի թիվ։'
        ],
        ...
        'report_data_not_found' => 'Նշված ժամանակահատվածի համար տվյալները բացակայում են։',
