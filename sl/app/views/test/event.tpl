...
//
        ...
        $(document).ready(function () {
            ...
            dataSource = new kendo.data.DataSource({
                transport: {
                        read:  {
                            url:"<?php echo ROOT;?>test/event/read",
                            dataType: "json"
                        },
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "event_qualification", title: "Event Qualification"  },
                    { field: "date", title: "Date",  format: "{0:yyyy-MM-dd HH:mm:tt}",
                        filterable: {
                            ui: setDateTimeP ,
                            extra: false,
                            operators: {
...
//                        content:'<?php echo ROOT; ?>open/bibliographyJoins/'+dataItem.id
                        content:'<?php echo ROOT; ?>add/man/'+dataItem.id
                    }).data("kendoWindow");
            wnd.center().open();
        }
