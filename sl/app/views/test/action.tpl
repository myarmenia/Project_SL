...
//
        ...
        $(document).ready(function () {
            ...
            dataSource = new kendo.data.DataSource({
                transport: {
                        read:  {
                            url:"<?php echo ROOT;?>test/action/read",
                            dataType: "json"
                        },
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "content_materials_actions", title: "Content Materials"  },
                    { field: "action_qualification", title: "Action Qualification" },
                    { field: "duration", title: "Duration"  },
                    { field: "goal", title: "Goal"  },
                    { field: "terms", title: "Terms" },
                    { field: "aftermath", title: "Aftermath" },
                    ...
                    { field: "source", title: "Source Information Actions"   },
