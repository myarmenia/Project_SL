...
//
        ...
        $(document).ready(function () {
            ...
            dataSource = new kendo.data.DataSource({
                transport: {
                        read:  {
                            url:"<?php echo ROOT;?>test/organization/read",
                            dataType: "json"
                        },
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "reg_date", title: "Registration Date",  format: "{0:yyyy-MM-dd HH:mm:tt}",
                        filterable: {
                            ui: setDateTimeP ,
                            extra: false,
                            operators: {
                    ...
                    { field: "country_ate", title: "Region Activity" },
                    { field: "category", title: "Organization Category"  },
                    { field: "employers_count", title: "Employers Count"  },
