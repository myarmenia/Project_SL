...
<div id="example" class="k-content">
    <div style="width: 70%; text-align: left">
        <?php
        $keyArray = array("reg_num", "content", "check_line", "check_status", "signal_qualification", "signal_qualification_idName", "source_resource", "source_resource_idName", "check_unit",
         "check_unit_idName", "check_agency", "check_agency_idName", "check_subunit", "check_subunit_idName", "checking_worker", "worker_post", "checking_worker_postName", "subunit_date", "check_date", "end_date",
         "worker", "uj", "worker_post_idName", "keep_count", "opened_subunit", "opened_unit", "opened_agency",
         "count_days", "resource", "resource_idName", "signal_result", "signal_result_idName", "taken_measure", "taken_measure_idName", "opened_dou", "opened_agency_idName", "opened_unit_idName", "opened_subunit_idName", "file_content");
    ...
    <div style="text-align: right">
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_signal?n=t"><?php echo $Lang->new_search?></a>
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_signal?n=f"><?php echo $Lang->change_search?></a>
    </div>
    <div id="grid"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            { field: "taken_measure_id",width: "175px", title: "<?php echo $Lang->measures_taken; ?>"  },
