        ...
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/operation_category/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/operation_category/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/operation_category/create",
                                type: 'post',
                                dataType: "json"
                            },
