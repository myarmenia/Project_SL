        ...
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/street/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/street/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/street/create",
                                type: 'post',
                                dataType: "json"
                            },
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "old_name", title: "<?php echo $Lang->old_name;?>", format: "{0:c}", width: "600px" },
