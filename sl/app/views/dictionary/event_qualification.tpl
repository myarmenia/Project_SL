        ...
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/event_qualification/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/event_qualification/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/event_qualification/create",
                                type: 'post',
                                dataType: "json"
                            },
