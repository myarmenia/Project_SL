...
<div id="example" class="k-content" style="height: 600px;">
    ...
    <div id="grid_optimization_car"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid_optimization_car").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "car_color",width: "280px", title: "<?php echo $Lang->color; ?>"  },
...
//                    content:'<?php echo ROOT; ?>open/weaponJoins/'
        ...
        function tableDelete(e) {
            ...
            if(confDel){
                $.ajax({
                    ...
                    data: { 'id' : dataItem.id } ,
                    success: function(data){
                        $("#grid_optimization_car").data("kendoGrid").dataSource.remove(dataItem);
                    },
                    faild: function(data){
        ...
        function editCar(e) {
            ...
            var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
            $.ajax({
                url: '<?php echo ROOT?>add/car/'+dataItem.bibliography_id+'/'+dataItem.id,
                dataType: 'html',
                success: function(data){
