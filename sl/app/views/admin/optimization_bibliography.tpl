...
<div id="example" class="k-content" style="height: 600px;">
    ...
    <div id="grid_optimization_bibliography" ></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid_optimization_bibliography").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "user_name",width: "360px", title: "<?php echo $Lang->worker_take_doc; ?>" },
        ...
        function tableDelete(e) {
            ...
            if(confDel){
                $.ajax({
                    ...
                    data: { 'id' : dataItem.id } ,
                    success: function(data){
                        $("#grid_optimization_bibliography").data("kendoGrid").dataSource.remove(dataItem);
                    },
                    faild: function(data){
