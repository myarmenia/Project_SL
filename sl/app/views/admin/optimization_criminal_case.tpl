...
<div id="example" class="k-content" style="height: 600px;">
    ...
    <div id="grid_optimization_criminal_case"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid_optimization_criminal_case").kendoGrid({
        ...
        function tableDelete(e) {
            ...
            if(confDel){
                $.ajax({
                    ...
                    data: { 'id' : dataItem.id } ,
                    success: function(data){
                        $("#grid_optimization_criminal_case").data("kendoGrid").dataSource.remove(dataItem);
                    },
                    faild: function(data){
