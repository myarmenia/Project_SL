<div style="width: 100%;">
    <table class="tableDetails">
        <tr>
            ...
            <td><?php if(!empty($data['address'])){ echo $data['address']; }?></td>
        </tr>
        <tr>
            <td><?php echo $Lang->email.' : '.$data['id']; ?></td>
...
<script>
    $(document).ready(function(){
        ...
        var wndT<?php echo $_SESSION['counter']; ?> = $(".details<?php echo $_SESSION['counter']; ?>")
            .kendoWindow({
                title: "<?php echo $Lang->email.' : '.$data['id']; ?>",
                modal: false,
                visible: false,
                resizable: true,
        ...
        $('.viewTies<?php echo $_SESSION['counter']; ?>').live('click',function(e){
            e.preventDefault();
            wndT<?php echo $_SESSION['counter']; ?>.refresh({ url: '<?php echo ROOT; ?>open/emailJoins/<?php echo $data['id']; ?>' });
