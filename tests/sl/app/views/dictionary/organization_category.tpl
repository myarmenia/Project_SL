        ...
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/organization_category/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/organization_category/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/organization_category/create",
                                type: 'post',
                                dataType: "json"
                            },
