...
//            var crudServiceBaseUrl = "http://demos.kendoui.com/service",
                   var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/signal_qualification/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/signal_qualification/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/signal_qualification/create",
                                type: 'post',
                                dataType: "json"
                            },
                        ...
                        schema: {
                            model: {
                                ...
                                fields: {
                                    ...
                                    old_id: { editable: false, nullable: false , type:'number'}
                                }
                            }
                        }
                    });
