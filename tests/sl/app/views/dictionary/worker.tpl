    ...
    <script>
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            read:  {
                                url:"<?php echo ROOT;?>dictionary/worker/read",
                                dataType: "json"
                            },
                            update: {
                                url:"<?php echo ROOT;?>dictionary/worker/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/worker/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/worker/create",
                                type: 'post',
                                dataType: "json"
                            },
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "first_name", title: "first_name", format: "{0:c}", width: "650px" },
                    { field: "last_name", title: "last_name", width: "200px" },
