        ...
        $(document).ready(function () {
            var dataSource = new kendo.data.DataSource({
                        transport: {
                            ...
                            update: {
                                url:"<?php echo ROOT;?>dictionary/education/update",
                                type: 'post',
                                dataType: "json"
                            },
                            destroy: {
                                url:"<?php echo ROOT;?>dictionary/education/destroy",
                                type: 'post',
                                dataType: "json"
                            },
                            create: {
                                url: "<?php echo ROOT;?>dictionary/education/create",
                                type: 'post',
                                dataType: "json"
                            },
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "name", title: "name", format: "{0:c}", width: "800px" },
