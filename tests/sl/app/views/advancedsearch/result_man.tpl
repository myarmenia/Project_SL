        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "man_belongs_country",width: "148px", title: "<?php echo $Lang->citizenship; ?>" },
                    { field: "man_knows_language",width: "160px", title: "<?php echo $Lang->knowledge_of_languages; ?>" },
                    ...
                    { field: "country_search_man", width: "320px",title: "<?php echo $Lang->country_carrying_out_search; ?>" },
