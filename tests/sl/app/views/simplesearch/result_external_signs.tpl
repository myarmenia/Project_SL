...
<div id="example" class="k-content">
    ...
    <div style="text-align: right">
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_external_signs?n=t"><?php echo $Lang->new_search?></a>
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_external_signs?n=f"><?php echo $Lang->change_search?></a>
    </div>
    <div id="grid"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            { field: "fixed_date", title: "<?php echo $Lang->time_fixation; ?>"  },
...
//                    content:'<?php echo ROOT; ?>open/weaponJoins/'
        ...
        function openWord(e) {
            e.preventDefault();
            var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
            window.open('<?php echo ROOT; ?>word/external_signs/'+dataItem.man_id, '_blank' );
        }
