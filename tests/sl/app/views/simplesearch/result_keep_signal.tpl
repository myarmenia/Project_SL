...
<div id="example" class="k-content">
    ...
    <div style="text-align: right">
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_keep_signal?n=t"><?php echo $Lang->new_search?></a>
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_keep_signal?n=f"><?php echo $Lang->change_search?></a>
    </div>
    <div id="grid"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            { field: "worker", width: "290px",title: "<?php echo $Lang->name_operatives; ?>" },
