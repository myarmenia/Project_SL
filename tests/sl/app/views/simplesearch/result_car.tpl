...
<div id="example" class="k-content">
    ...
    <div style="text-align: right">
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_car?n=t"><?php echo $Lang->new_search?></a>
        <a class="k-button k-button-icontext k-grid-resetFilter" href="<?php echo ROOT ;?>simplesearch/simple_search_car?n=f"><?php echo $Lang->change_search?></a>
    </div>
    <div id="grid"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    { command: { name:"aJoin", text: "<img src='<?php echo ROOT; ?>images/view.png' style='width: 30px;height: 30px;' title='<?php echo $Lang->view_ties; ?>' >", click: showDetailsCar }, width: "90px" },
                <?php if($user_type != 3 ) { ?>
                { command: { name:"aEdit", text: "<img src='<?php echo ROOT; ?>images/edit.png' style='width: 30px;height: 30px;' title='<?php echo $Lang->edit; ?>' >" , click: editCar }, width: "90px" },
            <?php } ?>
...
//                    content:'<?php echo ROOT; ?>open/weaponJoins/'
        ...
        $('#addNewCar').click(function(e){
            ...
            $.ajax({
                url:'<?php echo ROOT; ?>add/car/'+tb_name,
                dataType : 'html',
