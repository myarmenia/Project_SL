...
<div class="inContent">
    <form id="addressForm" action="<?php echo ROOT;?>simplesearch/result_address" method="post">

        <div class="buttons">
            <input type="button" class="k-button" value="<?php echo $Lang->and; ?>" id="address_and" />
            <input type="button" class="k-button" value="<?php echo $Lang->or; ?>" id="address_or" />
            <?php if(!isset($type)) { ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressCountry"><?php echo $Lang->country;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressRegionLocal"><?php echo $Lang->region_local;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressLocalityLocal"><?php echo $Lang->locality_local;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressStreetLocal"><?php echo $Lang->street_local;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressRegion"><?php echo $Lang->region;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="addressLocality"><?php echo $Lang->locality;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="addressStreet"><?php echo $Lang->street;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressTrack"><?php echo $Lang->track;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressHomeNum"><?php echo $Lang->home_num;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressHousingNum"><?php echo $Lang->housing_num;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchAddressAptNum"><?php echo $Lang->apt_num;?></label>
...
$(document).ready(function(){
    ...
    $('.addMore').click(function(e){
        ...
        $.fancybox({
            ...
            'width'             : 800,
            'height'            : 600,
            'href'              : "<?php echo ROOT;?>autocomplete/"+url+"&type=address"
        });
    });
