...
<div class="inContent">
    <form id="actionForm" action="<?php echo ROOT;?>simplesearch/result_action" method="post">

        <div class="buttons">
            <input type="button" class="k-button" value="<?php echo $Lang->and; ?>" id="action_and" />
            <input type="button" class="k-button" value="<?php echo $Lang->or; ?>" id="action_or" />
            <?php if(!isset($type)) { ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionContentMaterialsActions"><?php echo $Lang->content_materials_actions;?></label>
            <input type="text" name="material_content[]" id="searchActionContentMaterialsActions" class="oneInputSaveEnter"/>
            <?php if (isset($search_params['material_content_type']) && $search_params['material_content_type'] == 'OR') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionContentMaterialsActionsOp">ИЛИ</span>
            <?php } else if (isset($search_params['material_content_type']) && $search_params['material_content_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionContentMaterialsActionsOp">И</span>
            <?php } ?>
        </div>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionQualificationFact"><?php echo $Lang->qualification_fact;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionQualificationFactOp">ИЛИ</span>
            <?php } else if (isset($search_params['action_qualification_id_type']) && $search_params['action_qualification_id_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionQualificationFactOp">И</span>
            <?php } ?>
            <input type="hidden" name="action_qualification_id[]" id="searchActionQualificationFactId" />
        </div>

        <div class="forForm">
            <label for="searchActionStartActionDate"><?php echo $Lang->start_action_date;?></label>
        ...
        <div class="forForm">
            <label for="searchActionEndActionDate"><?php echo $Lang->end_action_date;?></label>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionDurationDAction"><?php echo $Lang->duration_action;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionDurationDActionOp">ИЛИ</span>
            <?php } else if (isset($search_params['duration_id_type']) && $search_params['duration_id_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionDurationDActionOp">И</span>
            <?php } ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionPurposeMotiveReason"><?php echo $Lang->purpose_motive_reason;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionPurposeMotiveReasonOp">ИЛИ</span>
            <?php } else if (isset($search_params['goal_id_type']) && $search_params['goal_id_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionPurposeMotiveReasonOp">И</span>
            <?php } ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionTermsActions"><?php echo $Lang->terms_actions;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionTermsActionsOp">ИЛИ</span>
            <?php } else if (isset($search_params['terms_id_type']) && $search_params['terms_id_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionTermsActionsOp">И</span>
            <?php } ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionEnsuingEffects"><?php echo $Lang->ensuing_effects;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionEnsuingEffectsOp">ИЛИ</span>
            <?php } else if (isset($search_params['aftermath_id_type']) && $search_params['aftermath_id_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionEnsuingEffectsOp">И</span>
            <?php } ?>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionSourceInformationActions"><?php echo $Lang->source_information_actions;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionSourceInformationActionsOp">ИЛИ</span>
            <?php } else if (isset($search_params['source_type']) && $search_params['source_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionSourceInformationActionsOp">И</span>
            <?php } ?>
        </div>
        ...
        <?php } ?>
        <div class="forForm">
            <label for="searchActionOpenedDow"><?php echo $Lang->opened_dou;?></label>
            ...
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionOpenedDowOp">ИЛИ</span>
            <?php } else if (isset($search_params['opened_dou_type']) && $search_params['opened_dou_type'] == 'AND') { ?>
            <span style="width: 30px;;position: absolute;margin-left: -570px;" id="searchActionOpenedDowOp">И</span>
            <?php } ?>
        </div>
    ...
    $(document).ready(function(){
        ...
        $('.addMore').click(function(e){
            ...
            $.fancybox({
                ...
                'width'             : 800,
                'height'            : 600,
                'href'              : "<?php echo ROOT;?>autocomplete/"+url+"&type=action"
            });
        });
        ...
        $('.addMoreSearch').click(function(e){
            ...
            $.fancybox({
                ...
                'width'             : 800,
                'height'            : 600,
                'href'              : "<?php echo ROOT;?>autocomplete/"+url+"&type=action&value="+$('#'+currentInputNameAction).val()
            });
        });
        ...
        <?php if (isset($search_params)) { ?>
            $('#searchActionContentMaterialsActions').val("<?php echo html_entity_decode($search_params['material_content'][sizeof($search_params['material_content'])-1]) ?>");
            $('#searchActionQualificationFactId').val("<?php echo $search_params['action_qualification_id'][sizeof($search_params['action_qualification_id'])-1] ?>");
            $('#searchActionQualificationFact').val("<?php echo html_entity_decode($search_params['action_qualification']) ?>");
            $('#searchActionDurationDActionId').val("<?php echo $search_params['duration_id'][sizeof($search_params['duration_id'])-1] ?>");
            $('#searchActionDurationDAction').val("<?php echo html_entity_decode($search_params['duration_name']) ?>");
            $('#searchActionPurposeMotiveReasonId').val("<?php echo $search_params['goal_id'][sizeof($search_params['goal_id'])-1] ?>");
            $('#searchActionPurposeMotiveReason').val("<?php echo html_entity_decode($search_params['goal_name']) ?>");
            $('#searchActionTermsActionsId').val("<?php echo $search_params['terms_id'][sizeof($search_params['terms_id'])-1] ?>");
            $('#searchActionTermsActions').val("<?php echo html_entity_decode($search_params['terms_name']) ?>");
            $('#searchActionEnsuingEffectsId').val("<?php echo $search_params['aftermath_id'][sizeof($search_params['aftermath_id'])-1] ?>");
            $('#searchActionEnsuingEffects').val("<?php echo html_entity_decode($search_params['aftermath_name']) ?>");
            $('#searchActionSourceInformationActions').val("<?php echo $search_params['source'][sizeof($search_params['source'])-1] ?>");
            $('#searchActionOpenedDow').val("<?php echo html_entity_decode($search_params['opened_dou'][sizeof($search_params['opened_dou'])-1]) ?>");
            $('#searchActionEndActionDate').val("<?php echo $search_params['end_date'] ?>");
            $('#searchActionStartActionDate').val("<?php echo $search_params['start_date'] ?>");
