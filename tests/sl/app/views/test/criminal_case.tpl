    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            dataSource = new kendo.data.DataSource({
                transport: {
                        read:  {
                            url:"<?php echo ROOT;?>test/criminal_case/read",
                            dataType: "json"
                        },
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "opened_date", title: "Opened Date",  format: "{0:yyyy-MM-dd HH:mm:tt}",
                        filterable: {
                            ui: setDateTimeP ,
                            extra: false,
                            operators: {
