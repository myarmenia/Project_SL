...
<div id="example" class="k-content" style="height: 600px;">
    ...
    <div id="grid_optimization_external_sign"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid_optimization_external_sign").kendoGrid({
                ...
                columns: [
                    ...
                    { command: { name:"aEdit", text: "<img src='<?php echo ROOT; ?>images/edit.png' style='width: 30px;height: 30px;' title='<?php echo $Lang->edit; ?>' >" , click: editExternalSigns }, width: "90px" },
...
//                    content:'<?php echo ROOT; ?>open/weaponJoins/'
        ...
        function tableDelete(e) {
            ...
            if(confDel){
                $.ajax({
                    ...
                    data: { 'id' : dataItem.id } ,
                    success: function(data){
                        $("#grid_optimization_external_sign").data("kendoGrid").dataSource.remove(dataItem);
                    },
                    faild: function(data){
        ...
        function editExternalSigns(e) {
            e.preventDefault();
            var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
            $.ajax({
                url: '<?php echo ROOT?>add/external_signs/'+dataItem.bibliography_id+'/'+dataItem.id,
                dataType: 'html',
                success: function(data){
