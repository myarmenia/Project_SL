...
<div id="example" class="k-content" style="height: 600px;">
    ...
    <div id="grid_optimization_address"></div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid_optimization_address").kendoGrid({
...
//                    content:'<?php echo ROOT; ?>open/weaponJoins/'
        ...
        function tableDelete(e) {
            ...
            if(confDel){
                $.ajax({
                    ...
                    data: { 'id' : dataItem.id } ,
                    success: function(data){
                        $("#grid_optimization_address").data("kendoGrid").dataSource.remove(dataItem);
                    },
                    faild: function(data){
        ...
        function editAddress(e) {
            ...
            var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
            $.ajax({
                url: '<?php echo ROOT?>add/address/'+dataItem.bibliography_id+'/'+dataItem.id,
                dataType: 'html',
                success: function(data){
