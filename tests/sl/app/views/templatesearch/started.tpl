...
<div class="inContent">
    <form id="startedForm" action="<?php echo ROOT;?>templatesearch/result/started" method="post">

        <div class="forForm" id="byDate">
            <label for="signalDateRegistrationDivision"><?php echo $Lang->date_registration_division;?></label>
            <input type="text" name="subunit_date" id="signalDateRegistrationDivision" style="width: 200px" onkeydown="validateNumber(event,'signalDateRegistrationDivision',12)" class="oneInputSaveEnter oneInputSaveDateSignal"/>
            ...
            <input type="text" name="subunit_date_to" id="signalDateRegistrationDivisionTO" style="width: 200px" onkeydown="validateNumber(event,'signalDateRegistrationDivisionTO',12)" class="oneInputSaveEnter oneInputSaveDateSignal"/>
        </div>

        <div class="forForm" >
            <label for="signalBroughtSignal"><?php echo $Lang->brought_signal;?></label>
