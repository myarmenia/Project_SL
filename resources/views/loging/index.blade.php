                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('loging.index') }}" method="get">
                        <div class="loging-search-block">
                            ...
                            <input type="text" class="form-control loging-search-input"
                                placeholder="{{ __('table.name') }}" name="first_name"
                                value="{{ request()->input('first_name') }}">
                            <input type="text" class="form-control loging-search-input"
                                placeholder="{{ __('table.last_name') }}" name="last_name"
                            ...
                            <input type="date" class="form-control loging-search-input" name="date_from"
