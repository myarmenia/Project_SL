            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('loging.index') }}" method="get">
                        ...
                        <input type="date" data-type="date" class="form-control loging-search-input"  name="date_from" value="{{ request()->input('date_from') }}">
                        <input type="date"  data-type="date" class="form-control loging-search-input"  name="date_to" value="{{ request()->input('date_to') }}">
