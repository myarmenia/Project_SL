                    ...
                    <div class="inputs row g-3">
                        ...
                        <div class="btn-div">
                            @if($modelData->name === 'man')
                                ...
                                <x-teg :item="$teg" :inputName="$modelData->name === 'man' ? 'organization_id' : 'man_id'" name="id" :redirect="['route'=>'work.create', 'model' => $modelData->name, 'id'=>$modelData->id, 'redirect'=> $modelData->redirect]" delete/>
                            @else
