            ...
            <div class="card-body">
                ...
                <form class="form">
                    <div class="inputs row g-3">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title get_datalist" id="item2"
                                    placeholder="" name="category_id" list="brow2"
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title get_datalist" id="item3"
                                    placeholder="" name="access_level_id" list="brow3"
                                    value="{{ $bibliography->access_level->name ?? null }}" {{-- data-update="{{route('bibliography.update',$bibliography->id)}}" --}} />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-fieldname ='name'
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder="" name="reg_number"
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                ...
                                <input type="date" placeholder="" id="inputDate1" class="form-control"
                                    placaholder="" name="reg_date" value="{{ $bibliography->reg_date ?? null }}"
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder=""
                                    name="worker_name" value="{{ $bibliography->worker_name ?? null }}" />
                                <label for="inputDate2" class="form-label">7) {{ __('content.worker_take_doc') }}</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title get_datalist" id="inputDate2"
                                    placeholder="" name="source_agency_id" list="brow5"
                                    value="{{ $bibliography->source_agency->name ?? null }}" />
                                <i class="i bi-hr icon icon-base my-plus-class" data-fieldname ='name'
                                    data-table-name='agency'></i>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder=""
                                    name="source_address" value="{{ $bibliography->source_address ?? null }}" />
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder=""
                                    name="short_desc" value="{{ $bibliography->short_desc ?? null }}" />
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder=""
                                    name="related_year" value="{{ $bibliography->related_year ?? null }}" />
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="inputDate2" placeholder=""
                                    name="source" value="{{ $bibliography->source ?? null }}" />
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                ...
                                <input type="text" class="form-control fetch_input_title teg_class get_datalist"
                                    ...
                                    data-parent-model-id ="{{ $bibliography->id }}" data-fieldname='name'
                            ...
                            <div class="form-floating">
                                <select class="form-select form-control select_class" id="selectElement"
                                    ...
                                    <option class = "bibliography_option"
                                        ...
                                        value="1"><a href="{{ route('table-content.index') }}">Վիճակագրության անձերի
                                            աղյուսակների ավելացում ինքնաաշխատ եղանակով</a></option>
                                    <option class = "bibliography_option" data-url="{{ route('reference') }}"
                                        value="1"><a href="{{ route('reference') }}">Տեղեկանք</a></option>
                                </select>
