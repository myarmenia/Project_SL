            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    { command: {
                        ...
                        click: showDetailsCriminalCase }, width: "90px"
                    },
                    ...
                    { command: {
                        ...
                        click: editCriminalCase }, width: "90px"
                    },
                    <?php } ?>
                    ...
                    { field: "number",  width: "135px",title: `{{ __('content.number_case') }}`  ,
                        filterable:{
                            ui: function (element) {
                                element.kendoNumericTextBox({
                                    format: "n0"
                    ...
                    { field: "opened_date",width: "350px", title: `{{ __('content.criminal_proceedings_date') }}`,  format: "{0:dd-MM-yyyy}",
                        filterable: {
                            ui: setDatePicker ,
                            extra: true
                        }
                    },
                    { field: "artical",width: "390px",title: `{{ __('content.criminal_code') }}`  },
                    { field: "opened_agency",width: "353px", title: `{{ __('content.materials_management') }}`  },
                    { field: "opened_unit",width: "310px", title: `{{ __('content.head_department') }}`   },
                    { field: "subunit",width: "385px", title: `{{ __('content.instituted_units') }}`   },
                    { field: "worker",width: "285px", title: `{{ __('content.name_operatives') }}` },
                    { field: "worker_post",width: "270px", title: `{{ __('content.worker_post') }}` },
                    { field: "character",width: "300px", title: `{{ __('content.nature_materials_paint') }}` },
                    { field: "opened_dou",width: "210px", title: `{{ __('content.initiated_dow') }}`  },
