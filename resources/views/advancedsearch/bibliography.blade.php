...
@section('content')
    ...
    <form id="advancedBibliography" method="post" action="{{ route('advanced_result_bibliography') }}">
        <div class="buttons">
            ...
            <input type="submit" class="k-button" id="submitAdvancedSearchBibliography"
                            ...
                            'success': function(data) {
                                if (data.status) {
                                    ...
                                    $.each(data.data, function(key, value) {
                                        $('#dataBibliography').append(
                                            '<input type="hidden" name="bibliography[]" value="' +
                                            value.id + '"/>');
                                    });
                                    countBibliography()
                                } else {
                        ...
                        $.ajax({
                            ...
                            'success': function(data) {
                                if (data.status) {
                                    $('#dataMiaSummary').html('');
                                    $.each(data.data, function(key, value) {
                                        $('#dataMiaSummary').append(
                                            '<input type="hidden" name="mia_summary[]" value="' +
                                            value.id + '"/>');
                                    });
                                    countBibliography()
                                } else {
                        ...
                        $.ajax({
                            ...
                            'success': function(data) {
                                if (data.status) {
                                    ...
                                    $.each(data.data, function(key, value) {
                                        $('#dataCrminalCase').append(
                                            '<input type="hidden" name="criminal_case[]" value="' +
                                            value.id + '"/>');
                                    });
                                    countBibliography()
                                } else {
