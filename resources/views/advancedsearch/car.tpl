...
<form id="advancedCar" method="post" action="<?php echo ROOT; ?>advancedsearch/result_car">
    <div class="buttons">
        <a href="" id="resetButton" class="k-button"><?php echo $Lang->reset; ?></a>
        <input type="submit" class="k-button" id="submitAdvancedSearchCar" value="<?php echo $Lang->search;?>" />
    </div>
...
<div id="tabstrip" >
    <ul>
        <li class="k-state-active" id="carAdv"><?php echo $Lang->car; ?></li>
...
<script>
    ...
    $(document).ready(function(e){
        ...
        $('#submitAdvancedSearchCar').click(function(e){
            e.preventDefault();
            countAjax = 0;
            $('#preloader').show();
