        ...
        $(document).ready(function () {
            ...
            var grid = $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "country_ate", width: "140px",title: `{{ __('content.country_ate') }}` },
                    { field: "region",width: "100px", title: `{{ __('content.region') }}` },
                    { field: "locality",width: "200px", title: `{{ __('content.locality') }}`  },
                    { field: "street", width: "100px",title: `{{ __('content.street') }}`  },
                    { field: "track",width: "290px", title: `{{ __('content.track') }}`   },
                    { field: "home_num",width: "140px", title: `{{ __('content.home_num') }}`   },
                    { field: "housing_num",width: "160px", title: `{{ __('content.housing_num') }}`   },
                    { field: "apt_num", width: "175px",title: `{{ __('content.apt_num') }}`   },
