                    ...
                    <div class="inputs row g-3">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                >1) {{__('content.name_organization')}}</label
                                >
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                >5) {{__('content.region_activity')}}</label
                                >
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                ></i>
                                <label for="country_id" class="form-label"
                                >7) {{__('content.category_organization')}}</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                >10) {{__('content.security_organization')}}</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                ...
                                >11) {{__('content.number_worker')}}</label
                                >
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                ...
                                >16) {{__('content.organization_dow')}}</label>
                            </div>
                        </div>
