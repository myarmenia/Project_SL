                ...
                <div class="form">
                    <div class="inputs row g-3">
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_organization')" :data="$organization" relation="organization_to_organization"
                                tableName="organization" related name="id" delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :data="$organization" relation="phone" name="number" tableName="phone" related
                                :label="__('content.short_phone')":label="__('content.short_address')" :edit="[
                                    'page' => 'phone.edit',
                                    'main_route' => 'organization.edit',
                                    'id' => $organization->id,
                                    'model' => 'organization',
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_email')" :data="$organization" relation="email" name="address" tableName="email"
                                related delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_event')" :data="$organization" relation="event" name="id"
                        ...
                        <div class="btn-div">
                            ...
                            {{-- <x-teg :item="$organization" inputName="dummy_address" name="name" tableName="address"
                                related :label="__('content.short_address')" delete :edit="[
                                    'page' => 'address.edit',
                                    'main_route' => 'organization.edit',
                                    'id' => $organization->id,
                                    'model' => 'organization',
                                ]" /> --}}
                            <x-tegs :data="$organization" relation="address" name="id" :label="__('content.short_address')"
                                tableName="address" related delete relationtype="has_many" />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_action')" :data="$organization" relation="action" name="id"
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_work_activity')" :data="$organization" relation="organization_has_man"
                                tableName="organization_has_man" related name="man_id" delete :edit="[
                                    'page' => 'work.edit',
                                    'main_route' => 'organization.edit',
                                    'id' => $organization->id,
                                    'model' => 'organization',
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_signal')" :data="$organization" relation="signal" name="id"
                                tableName="signal" related delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_signal')" :data="$organization" relation="passed" name="id"
                                tableName="signal" related delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <a
                                href="{{ route('open.page', ['page' => 'car', 'main_route' => 'organization.edit', 'model' => 'organization', 'model_id' => $organization->id, 'relation' => 'car']) }}">{{ __('content.addTo') }}</a>
                            <x-tegs :label="__('content.short_car')" :data="$organization" relation="car" name="id" tableName="car"
                                related delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_weapon')" :data="$organization" relation="weapon" name="id"
                                tableName="weapon" related delete />
                        </div>
                        ...
                        <div class="btn-div">
                            ...
                            <x-tegs :label="__('content.short_mia')" :data="$organization" relation="mia_summary" name="id"
                                tableName="mia_summery" related delete />
                        </div>
