                    ...
                    <div class="inputs row g-3">
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control save_input_data outline-red"
                                    ...
                                    tabindex=1 />
                                <label for="item1" class="form-label">1) Ահազանգի քարտի համար</label>
                            </div>
                        </div>
                        {{-- {{dd($signal)}} --}}
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control save_input_data" id="item2"
                                    ...
                                    tabindex=2 />
                                <label for="item2" class="form-label">3) Հ/հ աշխատանքի ուղություն, որով ստուգվում
                                    է</label>
                            </div>
                        </div>
                        ...
                        <div class="btn-div col">
                            ...
                            <button class="btn btn-primary  model-id" data-model-id='{{ $signal->id }}'
                                ...
                                data-bs-toggle="modal" data-bs-target="#additional_information">{{ __('content.addTo') }}
                            </button>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                ...
                                <label for="item3" class="form-label">5) Ահազանգի երանգավորում</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                <label for="item4" class="form-label">6) Տեղեկատվության աղբյուր</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    ...
                                    data-fieldname ='name'></i>
                                <label for="item5" class="form-label">7) Ահազանգ ստուգող վարչություն</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name='agency'
                                    data-fieldname ='name'></i>
                                <label for="item6" class="form-label">8) Ահազանգ ստուգող բաժին</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name='agency'
                                    data-fieldname ='name'></i>
                                <label for="item7" class="form-label">9) Ահազանգն ստուգող ստորաբաժանում</label>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title save_input_data get_datalist"
                                    name="worker" data-model="signal_checking_worker" {{-- wor tableum piti lcni --}}
                                    data-table="signal_checking_worker" data-type="create_relation"
                                    data-fieldname="worker" tabindex="8" />
                                <label for="item8" class="form-label">10) Ահազանգն ստուգող օ/ա ԱՀԱ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                ...
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    ...
                                    data-fieldname ='name'></i>
                                <label for="item9" class="form-label">11) Օ/ա պաշտոնը</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                ...
                                <input type="date" value="{{ $signal->subunit_date ?? null }}" id="item10"
                                    class="form-control fetch_input_title get_datalist save_input_data outline-red"
                                    name="subunit_date" data-type="update_field" tabindex="10" />
                                <label for="item10" class="form-label">12) Ահազանգի բացման ամսաթիվ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                <input type="date" value="{{ $signal->check_date ?? null }}" id="item11"
                                    class="form-control fetch_input_title get_datalist save_input_data outline-red"
                                    name="check_date" data-type="update_field" tabindex="11" />
                                <label for="item11" class="form-label">13) Ստուգման ժամկետի ամսաթիվ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating input-date-wrapper">
                                ...
                                <input type="date" id="item12"
                                    ...
                                    tabindex="12" />
                                <label for="item12" class="form-label">14) Ստուգման ժամկետի երկարաձգման ամսաթիվ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-floating input-date-wrapper">
                                ...
                                <label for="item13" class="form-label">15) Ահազանգի դադարեցման ամսաթիվ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control " id="item14" placeholder=""
                                    value="{{ $signal->count_number() }}" name="short_desc" tabindex="14" />
                                <label for="item14" class="form-label">16) Ժամկետանց ահազանգերի օրերի քանակը</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title get_datalist save_input_data"
                                    ...
                                    {{-- data-pivot-table = "signal_used_resource" --}} list="brow7" tabindex="15" />
                                <i class = "bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle = "modal"
                                    data-bs-target = "#fullscreenModal" data-table-name = "resource"
                                    data-fieldname = "name"></i>
                                <label for="item15" class="form-label">17) Ներգրավված ուժերը և միջոցները</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text"
                                    ...
                                    value="{{ $signal->signal_result->name ?? null }}" tabindex="16" list="brow8" />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name = "signal_result"
                                    data-fieldname = "name"></i>
                                <label for="item16" class="form-label">18) Ստուգման արդյունքները</label>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text"
                                    ...
                                    data-table = "has_taken_measure" data-fieldname="name" tabindex="17"
                                    list="brow9" />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name="taken_measure"
                                    data-fieldname = "name"></i>
                                <label for="item17" class="form-label">19) Ձեռնարկված միջոցները</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title get_datalist save_input_data"
                                    data-type="update_field" name="opened_dou" tabindex="18"
                                    value="{{ $signal->opened_dou ?? null }}" />
                                <label for="item18" class="form-label">20) Ստուգման արդյունքներով բացվել է ՕՀԳ</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text"
                                    ...
                                    list="brow10" tabindex="19" />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name="agency" data-fieldname='name'></i>
                                <label for="item19" class="form-label">28) Ահազանգը բացող վարչություն</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                ...
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name="agency" data-fieldname='name'></i>
                                <label for="item20" class="form-label">29) Ահազանգը բացող բաժին</label>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text"
                                    ...
                                    list="brow12" tabindex="21" />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name="agency" data-fieldname='name'></i>
                                <label for="item21" class="form-label">30) Ահազանգը բացող ստորաբաժանում</label>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control  save_input_data get_datalist" id="item22"
                                    ...
                                    {{-- wor tableum piti lcni --}} tabindex="22" data-fieldname='worker' />
                                <label for="item22" class="form-label">31) Օ/ա Ա․Հ․Ազգանուն</label>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control fetch_input_title save_input_data get_datalist"
                                    ...
                                    list="brow13" tabindex="23" data-fieldname='name' />
                                <i class="bi bi-plus-square-fill icon icon-base my-plus-class" data-bs-toggle="modal"
                                    data-bs-target="#fullscreenModal" data-table-name="worker_post"
                                    data-fieldname='name'></i>
                                <label for="item23" class="form-label">32) Օ/ա պաշտոնը</label>
                            </div>
                        ...
                        <div class="btn-div">
                            ...
                            <div class="file-upload-content tegs-div" name="tegsDiv1" id="company-police">
                                <x-teg :name="'id'" :item="$signal->bibliography" inputName="bibliography"
                                    inputValue="$signal->bibliography_id" :label="__('content.short_bibl')" />
                            </div>
                        </div>
