                ...
                <div class="card-body">
                    ...
                    <div class="edit-input-block">
                        ...
                        <div class="edit-button">
                            <button class="btn btn-primary edit-send-btn" onclick="editConfirm()">{{ __('content.confirm_translate') }}</button>
                        </div>
                    </div>

                       <div class="show-child-block">
                        <ul>
                            <li class="child-li">Aniko</li>
                            <li class="child-li">Anka</li>
                            <li class="child-li">Anush</li>
                            <li class="child-li">Annman</li>
                        </ul>
                        <input type="text" class="form-control" data-id="1" placeholder="{{ __('content.add_version') }}" onblur="editInputBlur(this)"> 
                    </div>
