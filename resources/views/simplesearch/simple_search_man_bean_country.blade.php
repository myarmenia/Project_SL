...
<div class="inContent">
    <form id="manBeanCountryForm" action="/{{ app()->getLocale() }}/simplesearch/result_man_bean_country" method="post">
        ...
        <div class="buttons">
            ...
            <?php if(!isset($type)) { ?>
            <a href="{{ route('simple_search_man_bean_country',['n'=> 't']) }}" id="resetButton" class="k-button">{{ __('content.reset') }}</a>
        ...
        <div class="forForm">
            ...
            <x-select-distance 
                ...
                class="distance distance_searchMbcRegion"/>
        ...
        <div class="forForm">
            ...
            <x-select-distance 
                ...
                class="distance distance_searchMbcLocality"/>
