    ...
    <div class="inContent">
        <form id="actionForm" action="/{{ app()->getLocale() }}/simplesearch/result_action" method="post">
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" name="material_content_type" id="searchActionContentMaterialsActionsType"
                    value="<?php echo $search_params['material_content_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                ...
                @if (isset($search_params['material_content_type']) && $search_params['material_content_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionContentMaterialsActionsOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['material_content_type']) && $search_params['material_content_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionContentMaterialsActionsOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['material_content_type']) && $search_params['material_content_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionContentMaterialsActionsOp">{{ __('content.not_equal') }}</span>
                @endif
            </div>
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="action_qualification_id_type" id="searchActionQualificationFactType"
                    value="<?php echo $search_params['action_qualification_id_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                ...
                <input type="button" dataName="searchActionQualificationFact" dataId="searchActionQualificationFactId"
                    dataTableName="fancy/action_qualification" class="addMore k-icon k-i-plus my-plus-class"
                    data-bs-toggle="modal" data-bs-target="#fullscreenModal" data-fieldname="name"
                    data-table-name="action_qualification" />
                <input type="text" name="action_qualification" dataInputId="searchActionQualificationFactId"
                    dataTableName="action_qualification" id="searchActionQualificationFact"
                    class="oneInputSaveEnter fetch_input_title get_datalist" list="action_qualification" />
                @if (isset($search_params['action_qualification_id_type']) && $search_params['action_qualification_id_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionQualificationFactOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['action_qualification_id_type']) && $search_params['action_qualification_id_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionQualificationFactOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['action_qualification_id_type']) && $search_params['action_qualification_id_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionQualificationFactOp">{{ __('content.not_equal') }}</span>
                @endif
            ...
            <div class="forForm">
                ...
                <input type="text" name="start_date" id="searchActionStartActionDate" style="width: 505px;"
                    class="oneInputSaveEnter oneInputSaveDateAction" />
            </div>


            <div class="forForm">
                <label for="searchActionEndActionDate">{{ __('content.end_action_date') }}</label>
                <input type="text" name="end_date" id="searchActionEndActionDate" style="width: 505px;"
                    class="oneInputSaveEnter oneInputSaveDateAction" />
            </div>
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="duration_id_type" id="searchActionDurationDActionType"
                    value="<?php echo $search_params['duration_id_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                <label for="searchActionDurationDAction">{{ __('content.duration_action') }}</label>
                <input type="button" dataName="searchActionDurationDAction" dataId="searchActionDurationDActionId"
                    dataTableName="fancy/duration" class="addMore k-icon k-i-plus my-plus-class" data-bs-toggle="modal"
                    data-bs-target="#fullscreenModal" data-fieldname="name" data-table-name="duration" />
                <input type="text" name="duration_name" id="searchActionDurationDAction"
                    dataInputId="searchActionDurationDActionId" dataTableName="duration"
                    class="oneInputSaveEnter fetch_input_title get_datalist" list="duration" />
                @if (isset($search_params['duration_id_type']) && $search_params['duration_id_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionDurationDActionOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['duration_id_type']) && $search_params['duration_id_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionDurationDActionOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['duration_id_type']) && $search_params['duration_id_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionDurationDActionOp">{{ __('content.not_equal') }}</span>
                @endif
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="goal_id_type" id="searchActionPurposeMotiveReasonType"
                    value="<?php echo $search_params['goal_id_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                <label for="searchActionPurposeMotiveReason">{{ __('content.purpose_motive_reason') }}</label>
                <input type="button" dataName="searchActionPurposeMotiveReason"
                    dataId="searchActionPurposeMotiveReasonId" dataTableName="fancy/action_goal"
                    class="addMore k-icon k-i-plus my-plus-class" data-bs-toggle="modal"
                    data-bs-target="#fullscreenModal" data-fieldname="name" data-table-name="action_goal" />
                <input type="text" name="goal_name" id="searchActionPurposeMotiveReason"
                    dataInputId="searchActionPurposeMotiveReasonId" dataTableName="action_goal"
                    class="oneInputSaveEnter fetch_input_title get_datalist" list="action_goal" />
                @if (isset($search_params['goal_id_type']) && $search_params['goal_id_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionPurposeMotiveReasonOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['goal_id_type']) && $search_params['goal_id_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionPurposeMotiveReasonOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['goal_id_type']) && $search_params['goal_id_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionPurposeMotiveReasonOp">{{ __('content.not_equal') }}</span>
                @endif
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="terms_id_type" id="searchActionTermsActionsType"
                    value="<?php echo $search_params['terms_id_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                <label for="searchActionTermsActions">{{ __('content.terms_actions') }}</label>
                <input type="button" dataName="searchActionTermsActions" dataId="searchActionTermsActionsId"
                    dataTableName="fancy/terms" class="addMore k-icon k-i-plus my-plus-class" data-bs-toggle="modal"
                    data-bs-target="#fullscreenModal" data-fieldname="name" data-table-name="terms" />
                <input type="text" name="terms_name" id="searchActionTermsActions"
                    dataInputId="searchActionTermsActionsId" dataTableName="terms"
                    class="oneInputSaveEnter fetch_input_title get_datalist" list="terms" />
                @if (isset($search_params['terms_id_type']) && $search_params['terms_id_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionTermsActionsOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['terms_id_type']) && $search_params['terms_id_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionTermsActionsOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['terms_id_type']) && $search_params['terms_id_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionTermsActionsOp">{{ __('content.not_equal') }}</span>
                @endif
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="aftermath_id_type" id="searchActionEnsuingEffectsType"
                    value="<?php echo $search_params['aftermath_id_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                <label for="searchActionEnsuingEffects">{{ __('content.ensuing_effects') }}</label>
                <input type="button" dataName="searchActionEnsuingEffects" dataId="searchActionEnsuingEffectsId"
                    dataTableName="fancy/aftermath" class="addMore k-icon k-i-plus my-plus-class" data-bs-toggle="modal"
                    data-bs-target="#fullscreenModal" data-fieldname="name" data-table-name="aftermath" />
                <input type="text" name="aftermath_name" id="searchActionEnsuingEffects"
                    dataInputId="searchActionEnsuingEffectsId" dataTableName="aftermath"
                    class="oneInputSaveEnter fetch_input_title get_datalist" list="aftermath" />
                @if (isset($search_params['aftermath_id_type']) && $search_params['aftermath_id_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionEnsuingEffectsOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['aftermath_id_type']) && $search_params['aftermath_id_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionEnsuingEffectsOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['aftermath_id_type']) && $search_params['aftermath_id_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionEnsuingEffectsOp">{{ __('content.not_equal') }}</span>
                @endif
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="source_type" id="searchActionSourceInformationActionsType"
                    value="<?php echo $search_params['source_type']; ?>">
            </div>
            <?php } ?>
            <div class="forForm">
                ...
                @if (isset($search_params['source_type']) && $search_params['source_type'] == 'OR')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionSourceInformationActionsOp">{{ __('content.or') }}</span>
                @elseif (isset($search_params['source_type']) && $search_params['source_type'] == 'AND')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionSourceInformationActionsOp">{{ __('content.and') }}</span>
                @elseif (isset($search_params['source_type']) && $search_params['source_type'] == 'NOT')
                    <span style="width: 30px;;position: absolute;margin-left: -570px;"
                        id="searchActionSourceInformationActionsOp">{{ __('content.not_equal') }}</span>
                @endif
            </div>
            ...
            <div style="width: 100%;text-align: right;top:14px;position: relative;">
                ...
                <input type="hidden" class="oneInputSaveEnter" readonly="readonly">
                <input type="hidden" name="opened_dou_type" id="searchActionOpenedDowType"
...
@section('js-include')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            showHideDistance('searchActionSourceInformationActions',
                'distance_searchActionSourceInformationActions');
            ...
            $('#searchActionTermsActionsId').val(
                `{{ $search_params['terms_id'][sizeof($search_params['terms_id']) - 1] }}`);
