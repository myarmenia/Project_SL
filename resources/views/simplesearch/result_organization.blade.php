...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['name_organization', 'nation', 'country_idName', 'reg_date', 'region_activity', 'country_ate_idName', 'category_organization', 'category_idName', 'security_organization', 'agency_idName', 'employers_count', 'opened_dou', 'content'];
                ...
                var grid = $("#grid").kendoGrid({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            field: "name",
                            width: "230px",
                            title: `{{ __('content.name_organization') }}`
                        },
                        {
                            field: "country",
                            width: "325px",
                            title: `{{ __('content.nation') }}`
                        },
                        {
                            field: "reg_date",
                            width: "315px",
                            title: `{{ __('content.date_formation') }}`,
                            format: "{0:dd-MM-yyyy}",
                            filterable: {
                                ui: setDatePicker,
                                extra: true
                        ...
                        },
                        {
                            field: "country_ate",
                            width: "220px",
                            title: `{{ __('content.region_activity') }}`
                        },
                        {
                            field: "category",
                            width: "235px",
                            title: `{{ __('content.category_organization') }}`
                        },
                        {
                            field: "employers_count",
                            width: "315px",
                            title: `{{ __('content.number_worker') }}`,
                            filterable: {
                                ui: function(element) {
                                    element.kendoNumericTextBox({
                                        format: "n0"
                        ...
                        },
                        {
                            field: "opened_dou",
                            width: "300px",
                            title: `{{ __('content.organization_dow') }}`
                        },
                        // {
                        //     field: "created_at",
                        //     width: "115px",
    ...
    //     wnd.refresh({
    //         url: `/{{ app()->getLocale() }}/open/organizationJoins/` + dataItem.id
    //     });
    //     wnd.center().open();
    // }
