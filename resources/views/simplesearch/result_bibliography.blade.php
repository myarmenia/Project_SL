...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            @php
                $keyArray = ['from_agency_idName', 'from_agency_name', 'category_title', 'category_idName', 'access_level_name', 'access_level_idName', 'reg_number', 'reg_date', 'worker_name', 'source_agency_name', 'source_agency_idName', 'source_address', 'short_desc', 'source', 'related_year', 'country', 'country_idName', 'theme', 'title', 'created_at', 'content'];
