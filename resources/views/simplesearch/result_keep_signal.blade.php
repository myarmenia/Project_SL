...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['management_signal', 'agency_idName', 'department_checking_signal', 'unit_idName', 'unit_signal', 'sub_unit_idName', 'worker', 'worker_post', 'worker_post_idName', 'start_date', 'end_date', 'pass_date', 'pased_sub_unit_name', 'pased_sub_unitName', 'content'];
