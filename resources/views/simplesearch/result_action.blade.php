...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['material_content', 'action_qualification_idName', 'duration_idName', 'goal_idName', 'terms_idName', 'aftermath_idName', 'source', 'opened_dou', 'action_qualification', 'duration_name', 'goal_name', 'terms_name', 'aftermath_name', 'start_date', 'end_date', 'content'];
    ...
    @section('js-include')
        ...
        <script>
            ...
            //     wnd.refresh({
            //         url: `/${lang}/open/actionJoins/` + dataItem.id
            //     });
            //     wnd.center().open();
            // }
