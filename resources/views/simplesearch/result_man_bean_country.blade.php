...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['goal', 'goal_idName', 'country_ate', 'country_ate_idName', 'entry_date', 'exit_date', 'region_name', 'region_idName', 'locality_local', 'locality_idName', 'region', 'locality', 'content'];
        ...
        <div id="grid"></div>
        <div class="details" id="table" data-tb-name="man_bean_country"></div>
                ...
                var grid = $("#grid").kendoGrid({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            field: "goal",
                            width: "120px",
                            title: `{{ __('content.purpose_visit') }}`
                        },
                        {
                            field: "country_ate",
                            width: "130px",
