...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['qualification_idName', 'qualification_name', 'date', 'aftermath_name', 'aftermath_idName', 'agency', 'agency_idName', 'result', 'resource_name', 'resource_idName', 'content'];
