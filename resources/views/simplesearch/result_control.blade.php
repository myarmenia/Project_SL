...
@section('content-include')
    ...
    <div id="example" class="k-content">
        <div style="width: 70%; text-align: left">
            <?php
            $keyArray = ['unit_idName', 'unit_name', 'category_title', 'doc_category_idName', 'creation_date', 'reg_num', 'reg_date', 'snb_director', 'snb_subdirector', 'resolution_date', 'resolution', 'act_unit_name', 'act_unit_idName', 'actor_name', 'sub_act_unit_name', 'sub_act_unit_idName', 'sub_actor_name', 'result_name', 'result_idName', 'content'];
    ...
    @section('js-include')
        <script>
            ...
            function showDetailsControl(e) {
                ...
                wnd.refresh({
                    url: `/{{ app()->getLocale() }}/open/controlJoins/` + dataItem.id
                });
                wnd.center().open();
            }
