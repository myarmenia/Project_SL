                        ...
                        <div class="col">
                            <div class="form-floating">
                                <select class="form-select form-control select_class" id="selectElement">
                                    ...
                                    <option class="event_option" data-url="{{route('reference', ['bibliography_id' => $event->bibliography?->id, 'table' => 'event_has_man', 'colum_name' => 'event_id', 'colum_name_id' => $event->id])}}" value="1">{{ __('content.reference') }}</option>1
                                </select>
